...
Route::get('/berita', [PublicController::class, 'semuaBerita'])->name('public.berita.index');
...
Route::middleware(['auth'])->group(function () {
    ...
    // ---------------------------------------------------------------------
    // A. LEVEL 1: BISA DIAKSES SEMUA ADMIN (Superadmin, Pasca, Prodi)
    // (Akses datanya sudah difilter masing-masing di AdminController)
    // ---------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------
    // B. LEVEL 2: HANYA BISA DIAKSES SUPER ADMIN & ADMIN PASCA
    // ---------------------------------------------------------------------
    Route::middleware(['role:superadmin,admin_pasca'])->group(function () {
    ...
    // ---------------------------------------------------------------------
    // C. LEVEL 3: ROOT PRIVILEGE (HANYA SUPER ADMIN)
    // ---------------------------------------------------------------------
