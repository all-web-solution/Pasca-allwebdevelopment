...
@section('content')
    ...
    <!-- ========================================================================= -->
    <!-- PANEL BARU: KELOLA VISI & PROFILE BERANDA -->
    <!-- ========================================================================= -->
        ...
        <form action="{{ route('admin.prodi.store') }}" method="POST" class="panel-form-body">
            ...
            <div class="form-flex-row" style="align-items: flex-end; margin-bottom:0;">
                <div class="form-input-cell" style="flex: 2;">
                    ...
                    <textarea name="deskripsi" rows="2" required placeholder="Tulis ringkasan prodi..."></textarea>
                </div>
    ...
    <!-- ========================================================================= -->
    <!-- APP MODALS CLASSIFICATION PREVIEW -->
    <!-- ========================================================================= -->
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // --- EVENT EVENT LISTENER FOR PROGRAM STUDI ---
